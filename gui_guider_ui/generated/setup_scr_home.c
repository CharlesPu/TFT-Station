...
int home_digital_clock_1_min_value = 2;
int home_digital_clock_1_hour_value = 14;
...
void setup_scr_home(lv_ui *ui)
{
	...
	ui->home_digital_clock_1 = lv_dclock_create(ui->home_tabview_1_tab_1, "14:02:47");
	...
	lv_obj_set_pos(ui->home_digital_clock_1, -10, 36);
	lv_obj_set_size(ui->home_digital_clock_1, 302, 78);
	...
	lv_obj_set_style_pad_top(ui->home_label_1, 4, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_label_set_text(ui->home_datetext_1, "2024/08/20");
	...
	lv_obj_set_size(ui->home_datetext_1, 85, 20);

	//Write style for home_datetext_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_text_color(ui->home_datetext_1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_pad_top(ui->home_datetext_1, 4, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(ui->home_datetext_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_left(ui->home_datetext_1, 4, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_style_pad_top(ui->home_label_2, 4, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(ui->home_label_2, 4, LV_PART_MAIN|LV_STATE_DEFAULT);
