...
void setup_scr_home(lv_ui *ui)
{
	...
	lv_obj_set_style_text_color(ui->home_label_traffic_txt, lv_color_hex(0xe6a397), LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_pos(ui->home_digital_clock_1, -13, 27);
	...
	lv_obj_set_pos(ui->home_label_tips, 0, -11);
	...
	lv_obj_set_style_text_color(ui->home_label_tips, lv_color_hex(0xaea6cf), LV_PART_MAIN|LV_STATE_DEFAULT);
